...
const SvgIconArrowPathUpFill = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  fill: "currentColor",
  d: "M4.393 8.934C3.695 9.744 4.271 11 5.34 11H8v9.25c0 .966.783 1.75 1.75 1.75h4.5A1.75 1.75 0 0 0 16 20.25V11h2.66c1.069 0 1.645-1.255.947-2.066l-6.281-7.293a1.75 1.75 0 0 0-2.652 0z"
}));
...
const SvgIconArrowTriangleDownFill = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  fill: "currentColor",
  d: "M4.187 6.534C3.613 5.388 4.427 4 5.735 4h12.53c1.309 0 2.122 1.388 1.548 2.534L13.547 19.04c-.64 1.28-2.453 1.28-3.094 0z"
}));
...
const SvgIconAttentionFill = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  fill: "currentColor",
  fillRule: "evenodd",
  d: "M7.537 3a1.75 1.75 0 0 0-1.701 1.338L2.02 20.073a.75.75 0 1 0 1.458.354l.71-2.927h8.956l-.624 2.573a.75.75 0 0 0 1.458.354l.71-2.927h5.123l.71 2.927a.75.75 0 1 0 1.457-.354L18.164 4.338A1.75 1.75 0 0 0 16.464 3zm9.713 3.933L15.052 16h4.396z",
  clipRule: "evenodd"
}));
...
const SvgIconBluetooth = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  strokeLinejoin: "round",
  strokeWidth: 1.5,
  d: "m11.912 12 4.828-3.95a.5.5 0 0 0 .003-.77l-5.215-4.346a.5.5 0 0 0-.82.384v7.697m1.204.985-1.204.985M11.912 12l4.828 3.95a.5.5 0 0 1 .003.771l-5.215 4.346a.5.5 0 0 1-.82-.384v-7.698M11.912 12l-1.204-.985m0 1.97-5.416 4.432m5.416-4.432v-1.97m0 0L5.292 6.583"
}));
...
const SvgIconCameraOffFlll = props => /*#__PURE__*/React.createElement("svg", _extends({
  xmlns: "http://www.w3.org/2000/svg",
  width: 24,
  height: 24,
  fill: "none",
...
const SvgIconCursor1 = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  strokeLinejoin: "round",
  strokeWidth: 1.5,
  d: "m14.5 14.5 4.7-4.7a.5.5 0 0 0-.179-.822L4.026 3.383a.5.5 0 0 0-.643.643l5.595 14.995a.5.5 0 0 0 .822.18l4.7-4.7Zm0 0 6.75 6.75"
}));
...
const SvgIconCursor3 = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  strokeLinejoin: "round",
  strokeWidth: 1.5,
  d: "M19.021 8.978 4.026 3.383a.5.5 0 0 0-.643.643l5.595 14.995a.5.5 0 0 0 .822.18l2.45-2.45 4.396 4.396a.5.5 0 0 0 .707 0l3.793-3.793a.5.5 0 0 0 0-.707L16.75 12.25 19.2 9.8a.5.5 0 0 0-.179-.822"
}));
...
const SvgIconFlashFill = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  fill: "currentColor",
  d: "M14 2.356c0-1.227-1.584-1.72-2.28-.71L3.172 14.04A1.25 1.25 0 0 0 4.202 16h5.797v5.644c0 1.227 1.583 1.72 2.28.71L20.825 9.96A1.25 1.25 0 0 0 19.797 8h-5.798z"
}));
...
const SvgIconFlashOffFill = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  fill: "currentColor",
  d: "M14 2.356c0-1.227-1.584-1.72-2.28-.71L7.835 7.28 3.249 3.19a.75.75 0 1 0-.998 1.12l18.5 16.5a.75.75 0 0 0 .998-1.12l-4.726-4.215 3.803-5.515A1.25 1.25 0 0 0 19.797 8h-5.798zM3.172 14.04 6.12 9.768l9.188 8.195-3.029 4.39c-.696 1.01-2.279.518-2.279-.709V16H4.201a1.25 1.25 0 0 1-1.029-1.96"
}));
...
const SvgIconFlashOff = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  fill: "currentColor",
  fillRule: "evenodd",
  d: "M7.835 7.28 3.249 3.19a.75.75 0 1 0-.998 1.12l18.5 16.5a.75.75 0 0 0 .998-1.12l-4.726-4.215 3.803-5.515A1.25 1.25 0 0 0 19.797 8h-5.798V2.356c0-1.227-1.583-1.72-2.279-.71zm1.128 1.006 6.931 6.182L19.321 9.5h-5.572c-.69 0-1.25-.56-1.25-1.25V3.158z",
  clipRule: "evenodd"
}), /*#__PURE__*/React.createElement("path", {
  fill: "currentColor",
  d: "m6.119 9.768 1.128 1.006-2.57 3.726h5.572c.69 0 1.25.56 1.25 1.25v5.091l2.68-3.885 1.128 1.007-3.029 4.39c-.696 1.01-2.279.518-2.279-.709V16H4.201a1.25 1.25 0 0 1-1.029-1.96L6.12 9.768Z"
}));
...
const SvgIconJudgeGavelFill = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  fill: "currentColor",
  d: "M17.737 3.427a1.75 1.75 0 0 0-2.474 0L9.926 8.763a1.75 1.75 0 0 0 0 2.475l1.335 1.335a1.75 1.75 0 0 0 2.475 0l2.138-2.137 4.345 4.344a.75.75 0 0 0 1.06-1.06l-4.344-4.345 2.137-2.137a1.75 1.75 0 0 0 0-2.475l-1.336-1.336ZM3.95 7.65a.75.75 0 1 0-.9 1.2l2 1.5a.75.75 0 1 0 .9-1.2zm-2.2 4.85a.75.75 0 0 0 0 1.5h2.5a.75.75 0 0 0 0-1.5zm3.72 4a1.75 1.75 0 0 0-1.66 1.197l-.6 1.803h-.46a.75.75 0 0 0 0 1.5h13.5a.75.75 0 0 0 0-1.5h-.46l-.6-1.803a1.75 1.75 0 0 0-1.66-1.197z"
}));
...
const SvgIconLaunchFill = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  fill: "currentColor",
  fillRule: "evenodd",
  d: "m15.5 14.324-4 3.177v1.564c0 .19.203.31.37.22l3.5-1.91a.25.25 0 0 0 .13-.219zM10 17.45 6.55 14H4.935a1.75 1.75 0 0 1-1.537-2.588l1.91-3.5A1.75 1.75 0 0 1 6.843 7h4.058c2.61-2.777 5.522-4.661 9.29-4.959a1.64 1.64 0 0 1 1.767 1.768c-.298 3.766-2.183 6.68-4.959 9.289v4.058c0 .64-.35 1.23-.912 1.537l-3.5 1.909A1.75 1.75 0 0 1 10 19.065zM9.676 8.5H6.844a.25.25 0 0 0-.22.13l-1.909 3.5a.25.25 0 0 0 .22.37h1.564z",
  clipRule: "evenodd"
}), /*#__PURE__*/React.createElement("path", {
  fill: "currentColor",
  d: "M1.998 19.194A2.805 2.805 0 1 1 4.804 22H2.748a.75.75 0 0 1-.75-.75z"
}));
...
const SvgIconMagicStar = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  strokeLinejoin: "round",
  strokeWidth: 1.5,
  d: "m12.773 12.227.99 4.102a.25.25 0 0 0 .457.072l2.13-3.465a.25.25 0 0 1 .232-.118l4.056.313a.25.25 0 0 0 .21-.411L18.21 9.623a.25.25 0 0 1-.04-.257l1.55-3.76a.25.25 0 0 0-.326-.327l-3.76 1.551a.25.25 0 0 1-.258-.04L12.28 4.151a.25.25 0 0 0-.412.21l.314 4.055a.25.25 0 0 1-.119.233l-3.465 2.13a.25.25 0 0 0 .072.456l4.103.991Zm0 0L4.75 20.25"
}));
...
const SvgIconTelephone = props => /*#__PURE__*/React.createElement("svg", _extends({
  ...
  strokeLinejoin: "round",
  strokeWidth: 1.5,
  d: "M7.755 9.218a15.9 15.9 0 0 0 2.953 4.074 15.9 15.9 0 0 0 4.074 2.954l1.79-1.791a.5.5 0 0 1 .61-.076l3.517 2.098a.5.5 0 0 1 .097.782l-3.583 3.583a.97.97 0 0 1-.963.251 19.7 19.7 0 0 1-4.396-1.92 20 20 0 0 1-3.957-3.07 20 20 0 0 1-3.07-3.957 19.8 19.8 0 0 1-1.92-4.396.97.97 0 0 1 .25-.963l3.584-3.583a.5.5 0 0 1 .783.097L9.62 6.817a.5.5 0 0 1-.076.61l-1.79 1.79Z"
}));
